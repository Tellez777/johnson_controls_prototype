...
class WebApplicationExtension:
    ...
    def _simulate_enhanced_scan(self, codigo):
        ...
        try:
            ...
            productos = current_data.get('productos', {})
            ...
            etapa_actual = producto.get('etapa_actual_numero', 1)
            progreso_actual = producto.get('progreso', 0.0)
            estado_actual = producto.get('estado', 'Pendiente')
            ...
            productos[codigo].update({
                'etapa_actual_numero': nueva_etapa,
                'etapa_actual': stages_info[nueva_etapa]['name'],
                'progreso': nuevo_progreso,
                'estado': nuevo_estado,
                'last_updated': datetime.now().isoformat(),
                'tiempo_ciclo': productos[codigo].get('tiempo_ciclo', 0) + 1
            })
